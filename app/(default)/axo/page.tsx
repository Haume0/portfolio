            ...
            <div className="bg-body p-4 space-y-6 sm:p-6 md:p-8 pt-0">
                ...
                >
                    <main className="flex col-span-1 lg:col-span-4 flex-col gap-4">
                        ...
                        >
                            Axo is a modern, lightweight, and efficient RESTful
                            API Scaffold written in Go. It is designed to
                            simplify the development of backend services by
                            leveraging the power of Go's standard library and
                            the popular GORM ORM for database interactions. Axo
                            aims to provide developers with a fast, scalable,
                            and easy-to-use framework for building robust APIs.
                        </motion.p>
                        <motion.span
                            initial={{
                                y: "-40%",
                    ...
                    >
                        ...
                        <p className="font-light text-center text-xl md:text-2xl lg:text-3xl">
                            A modern, lightweight, and efficient RESTful API
                            Scaffold written in Go.
                        </p>
                    </motion.div>
                </section>
            </div>
