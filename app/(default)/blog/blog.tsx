        ...
        <div className="flex flex-col w-full max-w-full gap-2 mt-12">
          <AnimatePresence mode="wait">
            {blogs.length > 0 ? (
                  ...
                  >
                    ...
                    >
                      <span className="size-full p-0 md:p-5 items-center gap-2 md:gap-3 flex flex-row *:text-start">
                        ...
                        <Link
                          href={`/blog/${blog.slug}`}
                          className="hover:underline flex-1 flex flex-col items-start text-left"
                        >
                          <h1 className="text-xl sm:text-2xl lg:text-3xl leading-[100%] line-clamp-2">
                            {blog.title}
                          </h1>
                        ...
                        <ImageTrace
                          image={blog.cover ? blog.cover : "/main.webp"}
                          title={blog.title}
                        />
                      </span>
                    </article>
              ...
              >
                <Icon icon="ion:sad-outline" fontSize="7rem" />
