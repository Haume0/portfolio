  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta property="og:title" content="Haume ▴ Emin Erçoban - I Make Dreams Come True" />
        ...
        <meta name="twitter:title" content="Haume ▴ Emin Erçoban - I Make Dreams Come True" />
        <meta name="twitter:description" content="Full-Stack Web Developer creating creative and eye-catching projects with modern technologies. 4 years of self-taught development experience." />
        ...
        <title>Haume ▴ Emin Erçoban - Full-Stack Web Developer | I Make Dreams Come True</title>
      </head>
