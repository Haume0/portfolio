                    ...
                    <div className="flex flex-col sm:flex-row gap-2 sm:justify-between w-full">
                        <span>
                            ...
                            <motion.p
                                ...
                                className=" font-light text-xl"
                            >
                                These designs are forged with modern
                                technologies.
                            </motion.p>
                        </span>
                ...
                >
                    <div className="flex col-span-1 lg:col-span-4 flex-col gap-4">
                        ...
                        >
                            ...
                            <strong>full stack web developer & designer</strong>{" "}
                            in Turkey/Antalya. My mission is to enhance
                            projects, applications with creative design and
                            modern technologies.
                        </motion.p>
                        <motion.p
                            initial={{
                            ...
                            className="font-light text-lg md:text-xl"
                        >
                            I'm currently working as a freelancer alongside my
                            best friend on platforms like Fiverr and Bionluk,
                            where we deliver{" "}
                            <strong>
                        ...
                        >
                            ...
                            developer. In 2023 i started studying in an
                            associate degree program. I met very nice people in
                            there, my current goal is to switch to a bachelor
                            program and get my license.
                        </motion.p>
