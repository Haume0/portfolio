...
export default function Blogs() {
    ...
    const [blogs, _blogs] = useState<BlogPost[] | null>(null);
                ...
                <section className="bg-blog p-4 sm:p-6 md:p-8 flex flex-col rounded-3xl size-full">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 sm:justify-between w-full">
                        <span>
                            ...
                            >
                                I share software and design tips filled with my
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <img
                                                            ...
                                                            alt={blog.title}
                                                            loading="eager"
                                                            className="rounded-sm aspect-[4/5] md:hidden object-center object-cover h-40 shadow-2xl"
                                                        />
                                                        <span className="size-full p-0 md:p-5 md:items-center gap-1 md:gap-4 flex md:flex-row flex-col items-start *:text-start">
                                                            ...
                                                            <Link
                                                                href={`/blog/${blog.id}`}
                                                                className="text-blog hover:underline text-sm sm:text-base"
                                                            >
                                                                Read Post
                                                            </Link>
                                                            <ImageTrace
