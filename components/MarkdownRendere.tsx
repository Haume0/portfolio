        ...
        <div className="space-y-5">
            <ReactMarkdown
                ...
                components={{
                    ...
                    h1: ({ children, ...props }) => (
                        <h1
                            className="text-3xl sm:text-4xl font-extrabold text-milk mb-4 first:mt-0 leading-tight"
                            {...props}
                        >
                            {children}
                        </h1>
                    ...
                    h2: ({ children, ...props }) => (
                        <h2
                            className="text-2xl sm:text-3xl font-bold text-milk mb-3 first:mt-0 leading-tight"
                            {...props}
                        >
                            {children}
                        </h2>
                    ...
                    h3: ({ children, ...props }) => (
                        <h3
                            className="text-xl sm:text-2xl font-bold text-milk mb-3 first:mt-0 leading-snug"
                            {...props}
                        >
                            {children}
                        </h3>
                    ...
                    h4: ({ children, ...props }) => (
                        <h4
                            className="text-lg sm:text-xl font-semibold text-milk mb-2 first:mt-0 leading-snug"
                            {...props}
                        >
                            {children}
                        </h4>
                    ...
                    h5: ({ children, ...props }) => (
                        <h5
                            className="text-base sm:text-lg font-medium text-milk mb-2 first:mt-0 leading-normal"
                            {...props}
                        >
                            {children}
                        </h5>
                    ...
                    h6: ({ children, ...props }) => (
                        <h6
                            className="text-base sm:text-lg text-milk/90 mb-2 first:mt-0 leading-normal"
                            {...props}
                        >
                            {children}
                        </h6>
                    ...
                    mark: ({ children, ...props }) => (
                        <mark
                            className="bg-works/30 text-milk px-1 rounded"
                            {...props}
                        >
                            {children}
                        </mark>
                    ...
                    p: ({ children, ...props }) => (
                        <p
                            className="text-milk/80  text-base sm:text-lg leading-relaxed"
                            {...props}
                        >
                            {children}
                        </p>
                    ...
                    pre: ({ children, ...props }) => (
                        <pre
                            className="rounded-xl bg-dark overflow-x-auto text-sm font-mono *:leading-relaxed *:tracking-wider"
                            {...props}
                        >
                            {children}
                        </pre>
                    ...
                    blockquote: ({ children, ...props }) => (
                        <blockquote
                            className="border-l-4 bg-works/10 border-works text-milk/90 pl-6 rounded-r-xl  backdrop-blur-sm"
                            {...props}
                        >
                            {children}
                        </blockquote>
                    ...
                    em: ({ children, ...props }: any) => (
                        <em
                            className="text-milk/80 italic  leading-relaxed"
                            {...props}
                        >
                            {children}
                        </em>
                    ...
                    ol: ({ children, ...props }) => (
                        <ol
                            className="text-milk/80  leading-relaxed list-decimal pl-7 space-y-2 marker:text-works marker:font-bold"
                            {...props}
                        >
                            {children}
                        </ol>
                    ...
                    li: ({ children, ...props }: any) => {
                        ...
                        if (isTaskItem) {
                            return (
                                <li
                                    {...props}
                                    className="flex items-center ehena gap-2 text-milk/90 leading-relaxed"
                                >
                                    {children}
                                </li>
                            );
                        ...
                        const realChildren = React.Children.toArray(
                            children,
                        ).filter(
                            (child) =>
                        ...
                        if (realChildren.length > 1) {
                            ...
                            return (
                                <details
                                    className="flex flex-col hover:bg-dark/15 rounded-xl -ml-7 group"
                                    {...props}
                                >
                                    <summary className="flex items-center gap-2 cursor-pointer group-hover:bg-dark/25 hover:bg-dark/40 px-2 py-1 rounded-xl transition-colors *:m-0">
                                        <Icon
                        ...
                        return (
                            <li
                                className="text-milk/90 leading-relaxed"
                                {...props}
                            >
                                {children}
                            </li>
                    ...
                    input: ({ type, checked, ...props }: any) => {
                        if (type === "checkbox") {
                            return (
                                <div
                                    className={`size-4.5 inline-grid rounded place-items-center ${checked ? "bg-works" : "bg-milk/20"}`}
                                >
                                    {checked ? (
                    ...
                    table: ({ children, ...props }) => (
                        <div className="overflow-x-auto rounded-xl border border-body/40 bg-grey/20">
                            <table
                    ...
                    tr: ({ children, ...props }) => (
                        <tr
                            className="bg-dark/20 transition-colors duration-200"
                            {...props}
                        >
                            {children}
                        </tr>
                    ...
                    hr: ({ ...props }) => (
                        <hr
                            className="border-0 border-milk/10 border-t-2"
                            {...props}
                        />
                    ),
                    ...
                    aside: ({ children, ...props }: any) => {
                        ...
                        return (
                            ...
                            >
                                {icon && (
                                    <div className="absolute pointer-events-none inset-0 text-[20rem] *:size-full opacity-20 scale-900 blur-3xl flex items-center justify-center">
                                        {icon}
                                    </div>
                                )}
                                {icon && (
